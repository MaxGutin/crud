        ...
        <div class="mdl-cell mdl-cell--12-col">
            ...
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" id="add_user">
                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                    <input class="mdl-textfield__input" type="text" id="header" name="header" required>
                    <label class="mdl-textfield__label" for="header">name</label>
                </div>
                <br>
                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                    <textarea class="mdl-textfield__input" rows="3" type="text" id="description" name="description"></textarea>
